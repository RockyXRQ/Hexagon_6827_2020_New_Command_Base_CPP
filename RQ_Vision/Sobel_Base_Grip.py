...
class GripPipeline:
    ...
    def process(self, source0):
        ...
        # Step CV_Sobel0:
        self.__cv_sobel_0_src = self.desaturate_output
        (self.cv_sobel_0_output) = self.__cv_sobel(self.__cv_sobel_0_src, self.__cv_sobel_0_dx, self.__cv_sobel_0_dy, self.__cv_sobel_0_ksize, self.__cv_sobel_0_scale, self.__cv_sobel_0_delta, self.__cv_sobel_0_bordertype)

        # Step CV_Sobel1:
        self.__cv_sobel_1_src = self.desaturate_output
        (self.cv_sobel_1_output) = self.__cv_sobel(self.__cv_sobel_1_src, self.__cv_sobel_1_dx, self.__cv_sobel_1_dy, self.__cv_sobel_1_ksize, self.__cv_sobel_1_scale, self.__cv_sobel_1_delta, self.__cv_sobel_1_bordertype)

        # Step CV_addWeighted0:
        self.__cv_addweighted_src1 = self.cv_sobel_0_output
        self.__cv_addweighted_src2 = self.cv_sobel_1_output
        (self.cv_addweighted_output) = self.__cv_addweighted(self.__cv_addweighted_src1, self.__cv_addweighted_alpha, self.__cv_addweighted_src2, self.__cv_addweighted_beta, self.__cv_addweighted_gamma)
