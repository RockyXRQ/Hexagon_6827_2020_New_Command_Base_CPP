#转自CSDN 版权声明：本文为CSDN博主「frank909」的原创文章
#作者：frank909 链接：https://blog.csdn.net/briblue/article/details/86569448 
    ...
    while (True):
        ...
        if cv2.waitKey(1) & 0xFF == ord(' '):
            ...
            ret, corners = cv2.findChessboardCorners(
                gray, (Nx_cor, Ny_cor), None)  # Find the corners
            ...
            if ret == True:
                ...
                cv2.drawChessboardCorners(
                    frame, (Nx_cor, Ny_cor), corners, ret)
                count += 1
